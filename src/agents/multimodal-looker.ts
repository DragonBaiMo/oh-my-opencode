...
export function createMultimodalLookerAgent(model: string): AgentConfig {
  ...
  return {
    description:
      "Analyze media files (PDFs, images, diagrams). Extracts information from documents, describes visual content. Use when you need analyzed data rather than literal file contents.",
    mode: MODE,
    model,
    temperature: 0.1,
    ...restrictions,
