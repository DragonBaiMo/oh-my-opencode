...
export function createDelegateTask(options: DelegateTaskToolOptions): ToolDefinition {
  ...
  **DO NOT provide both.** If category is provided, subagent_type is ignored.
  ...
  - load_skills: ALWAYS REQUIRED. Pass [] if no skills needed, but IT IS HIGHLY RECOMMENDED to pass proper skills like ["git-master"], ["frontend-ui-ux"] for best results.
